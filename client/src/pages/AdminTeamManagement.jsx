            ...
            <Layout title="Team Management">
                <div className="space-y-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div>
                            <p className="text-gray-600 mt-1 text-sm sm:text-base">Create and manage teams with detailed tracking</p>
                        </div>
                        <button
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="space-y-3 mb-4">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            {/* Health Status */}
                                            <div className={`p-3 rounded-xl border ${team.healthStatus === 'healthy' ? 'bg-green-50 border-green-200' :
                                                    team.healthStatus === 'at_risk' ? 'bg-yellow-50 border-yellow-200' :
                                                        'bg-red-50 border-red-200'
                                                }`}>
                                                <div className="flex items-center justify-between">
                                                    <div className="flex items-center gap-2">
                                                        <div className={`w-2 h-2 rounded-full ${team.healthStatus === 'healthy' ? 'bg-green-500' :
                                                                team.healthStatus === 'at_risk' ? 'bg-yellow-500' :
                                                                    'bg-red-500'
                                                            }`}></div>
                                                        <span className="text-sm font-semibold text-gray-900">Team Health</span>
                                                    </div>
                                                    <span className={`text-xs font-bold px-2 py-1 rounded-lg ${team.healthStatus === 'healthy' ? 'bg-green-100 text-green-700' :
