        ...
        <Layout title="Activity Logs">
            <div className="space-y-5" style={{ background: '#FAF9F8' }}>
                ...
                <div className="flex flex-wrap lg:flex-nowrap gap-3 items-center">
                    <div className="relative w-full sm:w-80 lg:w-[700px] bg-white rounded-[1.5rem] shadow-sm border border-gray-100 group focus-within:ring-2 focus-within:ring-[#1D1110]/10 transition-all flex items-center">
