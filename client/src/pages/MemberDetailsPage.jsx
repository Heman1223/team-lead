    ...
    return (
        <Layout title={user.name}>
            <div className="space-y-6">
                ...
                {/* Member Profile Card */}
                <div className="bg-gradient-to-r from-[#3E2723] to-[#5D4037] rounded-2xl p-6 sm:p-8 text-white shadow-xl">
                    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                        <div className="w-24 h-24 sm:w-32 sm:h-32 bg-white bg-opacity-20 rounded-2xl flex items-center justify-center text-4xl sm:text-6xl font-bold shadow-lg">
                            {user.name?.charAt(0).toUpperCase()}
                        </div>
                        <div className="flex-1">
                            <h1 className="text-2xl sm:text-4xl font-bold mb-2">{user.name}</h1>
                            <div className="space-y-2 mb-4">
                                <div className="flex items-center justify-center sm:justify-start gap-2 text-[#D7CCC8]/80">
                                ...
                                {user.phone && (
                                    <div className="flex items-center justify-center sm:justify-start gap-2 text-[#D7CCC8]/80">
                                        ...
                                        <span className="text-sm sm:text-lg">{user.phone}</span>
                                    </div>
                                )}
                            </div>
                            <div className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3 flex-wrap">
                                <div className="flex items-center gap-2 bg-white bg-opacity-20 px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm">
                        ...
                        <div className="sm:text-right mt-4 sm:mt-0">
                            <p className="text-[#D7CCC8]/80 text-xs mb-1">Status</p>
                            <p className={`text-lg sm:text-xl font-bold px-4 py-2 rounded-lg ${
                ...
                <div className={`rounded-2xl p-6 border-2 ${getActivityBgColor(activityLevel)}`}>
                    <div className="flex flex-col sm:flex-row items-center justify-between mb-4 gap-4">
                        <div className="text-center sm:text-left">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1">Activity Level</h2>
                            <p className="text-sm text-gray-600">Based on last 7 days performance</p>
                        </div>
                        <div className="text-center">
                            <div className={`text-3xl sm:text-5xl font-bold ${getActivityColor(activityLevel)}`}>
                                {activityLevel}
                            </div>
                ...
                <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
                    <div className="bg-blue-50 rounded-xl p-4 sm:p-5 border border-blue-200">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <p className="text-[10px] sm:text-xs text-gray-600 font-medium whitespace-nowrap">Total Tasks</p>
                                <p className="text-2xl sm:text-3xl font-bold text-gray-900">{taskStats.total}</p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-green-50 rounded-xl p-4 sm:p-5 border border-green-200">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <p className="text-[10px] sm:text-xs text-gray-600 font-medium whitespace-nowrap">Completed</p>
                                <p className="text-2xl sm:text-3xl font-bold text-green-600">{taskStats.completed}</p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-[#D7CCC8]/20 rounded-xl p-4 sm:p-5 border border-[#D7CCC8]/40">
                        <div className="flex items-center gap-3 mb-2">
                            <div className="p-2 sm:p-3 bg-[#D7CCC8]/30 rounded-lg">
                                <Activity className="w-5 h-5 sm:w-6 sm:h-6 text-[#3E2723]" />
                            </div>
                            <div>
                                <p className="text-[10px] sm:text-xs text-gray-600 font-medium whitespace-nowrap">In Progress</p>
                                <p className="text-2xl sm:text-3xl font-bold text-[#3E2723]">{taskStats.inProgress}</p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-yellow-50 rounded-xl p-4 sm:p-5 border border-yellow-200">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <p className="text-[10px] sm:text-xs text-gray-600 font-medium whitespace-nowrap">Pending</p>
                                <p className="text-2xl sm:text-3xl font-bold text-yellow-600">{taskStats.pending}</p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-red-50 rounded-xl p-4 sm:p-5 border border-red-200">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                <p className="text-[10px] sm:text-xs text-gray-600 font-medium whitespace-nowrap">Overdue</p>
                                <p className="text-2xl sm:text-3xl font-bold text-red-600">{taskStats.overdue}</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            {tasks.map(task => (
                                <div key={task._id} className="p-5 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors border border-gray-200">
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-3 gap-3">
                                        <div className="flex-1">
                                            <h4 className="font-bold text-gray-900 text-base sm:text-lg mb-1">{task.title}</h4>
                                            {task.description && (
                                                <p className="text-xs sm:text-sm text-gray-600 mb-2">{task.description}</p>
                                            )}
                                        </div>
                                        <span className={`px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-semibold rounded-lg whitespace-nowrap ${
                                    ...
                                    <div className="grid grid-cols-1 xs:grid-cols-2 lg:flex items-center gap-4 sm:gap-6 text-xs text-gray-600">
                                        ...
                                        {task.assignedBy && (
                                            <div className="flex items-center gap-2">
                                                <span>By: <span className="font-medium">{task.assignedBy.name}</span></span>
                                            </div>
                                        )}
                                    </div>
                                </div>
